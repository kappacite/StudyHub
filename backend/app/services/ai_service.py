...
class AIService:
    ...
    def generate_flashcards(
        ...
        system_prompt = (
            ...
            "- Atomicité : une carte = un seul point testé et une seule réponse univoque. "
            "Jamais de questions à tiroirs ni de réponses sous forme de longs paragraphes.\n"
            "- Recto ('front') LE PLUS COURT POSSIBLE. Va droit au but : le recto est un simple "
            "indice de rappel, pas une phrase d'examen. Supprime tout habillage conversationnel "
            "(« Comment dit-on… ? », « Quelle est… ? », « Peux-tu citer… ? »). Quand un terme, un "
            "mot, une date ou un nom suffit à déclencher le rappel, écris-le SEUL, sans phrase autour.\n"
            "  Exemples : pour du vocabulaire, préfère « Après-midi » à « Comment dit-on 'Après-midi' "
            "en néerlandais ? » ; préfère « Bataille de Marignan » à « En quelle année s'est déroulée "
            "la bataille de Marignan ? » ; préfère « Rôle des mitochondries » à « Quelle est la "
            "fonction principale des mitochondries dans la cellule ? ».\n"
            "- N'écris une question développée QUE si un recto court serait ambigu (ex. distinguer une "
            "cause d'une conséquence, une définition d'un exemple) ; dans ce cas, garde-la minimale.\n"
            "- Le recto reste répondable par quelqu'un qui a appris le sujet, sans avoir le document "
            "sous les yeux, et porte sur le FOND du cours : n'évoque jamais « le document » ou « le texte ».\n"
