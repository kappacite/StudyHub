...
def upgrade():
    ...
    with op.batch_alter_table('decks', schema=None) as batch_op:
        batch_op.create_index('decks_search_idx', ['search_vector'], unique=False, postgresql_using='gin')

    with op.batch_alter_table('diagrams', schema=None) as batch_op:
        batch_op.create_index('diagrams_search_idx', ['search_vector'], unique=False, postgresql_using='gin')

    with op.batch_alter_table('flashcards', schema=None) as batch_op:
        batch_op.create_index('flashcards_search_idx', ['search_vector'], unique=False, postgresql_using='gin')

    with op.batch_alter_table('notes', schema=None) as batch_op:
        batch_op.create_index('notes_search_idx', ['search_vector'], unique=False, postgresql_using='gin')
...
def downgrade():
    ...
    with op.batch_alter_table('notes', schema=None) as batch_op:
        batch_op.drop_index('notes_search_idx', postgresql_using='gin')

    with op.batch_alter_table('flashcards', schema=None) as batch_op:
        batch_op.drop_index('flashcards_search_idx', postgresql_using='gin')

    with op.batch_alter_table('diagrams', schema=None) as batch_op:
        batch_op.drop_index('diagrams_search_idx', postgresql_using='gin')

    with op.batch_alter_table('decks', schema=None) as batch_op:
        batch_op.drop_index('decks_search_idx', postgresql_using='gin')
