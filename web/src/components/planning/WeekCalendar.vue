<template>
  ...
  <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
    ...
    >
      ...
      <div class="mt-4">
        <div
          class="flex items-center justify-between text-[10px] font-bold uppercase tracking-wider text-ink-subtle mb-1"
        >
          <span>Charge</span>
      ...
      <div class="flex-1 mt-4 space-y-2.5 overflow-y-auto max-h-[160px] pr-1">
        ...
        >
          <span class="font-bold text-ink-muted truncate flex-1 min-w-0 mr-2" :title="item.name">
            {{ item.name }}
          </span>
      ...
      <div
        ...
        class="mt-4 pt-2 border-t border-line-soft"
      >
        <button
