...
import WeekCalendar from '../../../src/components/planning/WeekCalendar.vue'
import type { PlanningDay } from '../../../src/services/planningService'

describe('WeekCalendar — notes-ia-planning-corrections Task 2 (breakdown kind/id/name)', () => {
  it('affiche le nom des items deck ET revision_set (plus deck_id/deck_name)', () => {
    ...
    const wrapper = mount(WeekCalendar, { props: { days } })
